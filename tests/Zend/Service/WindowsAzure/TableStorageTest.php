...
class Zend_Service_WindowsAzure_TableStorageTest extends PHPUnit\Framework\TestCase
{
    ...
    public function testRetrieveEntityById_DynamicTableEntity()
    {
        if (TESTS_ZEND_SERVICE_WINDOWSAZURE_TABLE_RUNTESTS)  {
            ...
            $this->assertInstanceOf(Zend_Service_WindowsAzure_Storage_DynamicTableEntity::class, $result);
        }
    }
    ...
    public function testRetrieveEntities_All_DynamicTableEntity()
    {
        if (TESTS_ZEND_SERVICE_WINDOWSAZURE_TABLE_RUNTESTS) {
            ...
            {
                $this->assertInstanceOf(Zend_Service_WindowsAzure_Storage_DynamicTableEntity::class, $item);
            }
        }
    }
    ...
    public function testBatchCommit_Success()
    {
        if (TESTS_ZEND_SERVICE_WINDOWSAZURE_TABLE_RUNTESTS) {
            ...
            $this->assertInstanceOf(Zend_Service_WindowsAzure_Storage_Batch::class, $batch);
